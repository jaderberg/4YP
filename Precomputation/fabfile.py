...
def precompute():
    ...
    if run_mongodb:
        prompt('Mongodb data directory: ', key='mongo_data', default='~/4YP/data/d_rootaffine/mongodb')
        prompt('Mongodb log directory: ', key='mongo_logs', default='~/4YP/data/d_rootaffine/mongo_logs')
