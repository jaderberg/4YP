...
def precompute():
    ...
    if run_mongodb:
        prompt('Mongodb data directory: ', key='mongo_data', default='~/4YP/data/d_ransac_turbo/mongodb')
        prompt('Mongodb log directory: ', key='mongo_logs', default='~/4YP/data/d_ransac_turbo/mongo_logs')
...
def full_precompute():
    ...
    if skip_vocab:
        ...
        root_dir = prompt('Project root dir: ', default='~/4YP/data/d_ransac_turbo')
