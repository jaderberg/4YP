...
# Max Jaderberg 2012
#
# Downloads verification images from Ebay using Google image api
# TODO: use result url to link to the ebay page
...
OUT_DIR = '/Volumes/4YP/Images/ukno1albums_ebay'
IMS_PER_CLASS = 5
EXCLUDE_DOMAIN = 'wikipedia.org' # or None
SITE = 'ebay.co.uk' # or None
