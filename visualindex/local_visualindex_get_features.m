function [f,d] = local_visualindex_get_features(im,varargin)
...
if ~opts.affine
    ...
    imwrite(im, temp_im);
    system(['affine_detector/mac_bin/detect_points -i ' temp_im ' -hesaff -o ' det ' > ' det_log]);
    system(['affine_detector/mac_bin/compute_descriptors -i ' temp_im ' -p1 ' det ' -sift -o3 ' desc ' -scale-mult 1.732 > ' desc_log]);
